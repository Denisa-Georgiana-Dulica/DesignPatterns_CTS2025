package ctsCreationale.test1.singleton.main;

import ctsCreationale.test1.singleton.classes.AbstractTourismLicense;
import ctsCreationale.test1.singleton.classes.LicenseAlreadySetException;
import ctsCreationale.test1.singleton.classes.TourismLicense;
